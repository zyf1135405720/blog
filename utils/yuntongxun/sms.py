...
_accountSid = '8a216da86b8863a1016b927571870753'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '436e8438dd2041cd82fa6cd3b7063987'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da86b8863a1016b927571e50759'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('13479940164', ['6666', 5], 1)
        if result == 0:
            print('短信验证码发送成功！')
            break
